...
silent only
cd ~/Documentos/Programas/Scala/patmat
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/main/scala/patmat/Huffman.scala
badd +0 src/test/scala/patmat/HuffmanSuite.scala
argglobal
silent! argdel *
set stal=2
edit src/main/scala/patmat/Huffman.scala
...
setlocal nodiff
setlocal equalprg=
setlocal errorformat=%E\ %#[error]\ %f:%l:%c:\ %m,%C\ %#[error]\ %p^,%-C%.%#,%Z,%W\ %#[warn]\ %f:%l:%c:\ %m,%C\ %#[warn]\ %p^,%-C%.%#,%Z,%-G%.%#
setlocal expandtab
if &filetype != 'scala'
...
silent! normal! zE
let s:l = 28 - ((26 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
28
normal! 0
tabedit src/test/scala/patmat/HuffmanSuite.scala
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
